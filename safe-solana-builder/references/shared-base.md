...
Read every line of this file before writing any program code.
...
- Avoid `init_if_needed` for accounts an adversary can pre-initialize with harmful state. Use `init` for one-time initialization.
